...
dan memakan waktu yang kecil untuk pemrosesannya.</h6>
    ...
    function fetchData() {
        ...
        xhr.open("GET", "http://127.0.0.1:5000/count-data-training", true);
    ...
    function renderChart(data) {
        ...
        var myChart = new Chart(ctx, {
            ...
            data: {
                labels: labels,
                datasets: [{
                    label: 'Jumlah Ulasan Berdasarkan Rating',
                    data: counts,
    ...
    function displayData(data) {
        ...
        var html = "<h1>Data Training</h1><table><thead><tr><th>Raw Content</th><th>Status</th></tr></thead><tbody>";

        data.forEach(function(item) {
            html += "<tr><td>" + item.rawContent + "</td><td>" + item.status + "</td></tr>";
        });
