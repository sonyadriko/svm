...
if ($data) {
    // Tampilkan hasil
    echo "Sentimen: " . $data['sentiment'] . "<br>";
    echo "Akurasi Positif: " . $data['accuracy_positif'] . "<br>";
    echo "Akurasi Negatif: " . $data['accuracy_negatif'] . "<br>";
    echo "Hasil:<br>";
    foreach ($data['results'] as $result) {
        echo "Rank: " . $result['rank'] . "<br>";
        echo "Data Number: " . $result['data_number'] . "<br>";
        echo "Cosine Similarity: " . $result['cosine_similarity'] . "<br>";
        echo "Tweet: " . $result['tweet'] . "<br><br>";
    }
} else {
...
?>
    ...
    document.getElementById("preprocessingButton").addEventListener("click", function() {
        ...
        xhr.open("GET", "http://127.0.0.1:5000/similarity", true);
